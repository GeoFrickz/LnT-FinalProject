...
<body>
    ...
    <form action="{{route('checkout')}}" method="POST">
        ...
        <div class="content">
            <?php
                $invoiceNumber = "1000" . str_pad(rand(0, 9999), 4, "0", STR_PAD_LEFT);
            ?>
            <div class="invoice">
                <label for="OrderInvoice">Nomor Invoice</label>
                <input id="invoice" type="text" name="OrderInvoice" value="{{$invoiceNumber}}" readonly>
            </div>
            ...
            <div class="alamat-isi">
                ...
                <div class="alamat-address">
                    <label for="address">Alamat pengiriman</label>
                    <input id="alamat" type="text" name="address" placeholder="Masukkan alamat anda" minlength="10" maxlength="100">
                    <label for="postCode">Kode Pos</label>
                    <input id="post-code" type="text" name="postCode" placeholder="Masukkan kode pos anda" minlength="5" maxlength="5">
                </div>
            </div>
        </div>
        <div class="content">
