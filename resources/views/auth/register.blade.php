...
<body>
    ...
    <section id="form-section">
            <form  action="{{ route('register') }}" id="reg" method="POST" class="form" onsubmit="return validateForm()">
             @csrf
            <div class="input">
                <div class="input-box">
                    <input type="text" placeholder="First name" id="firstName" name="Fname" required minlength="3" maxlength="40">
                    <div id="error-first-name" class="error-message"></div>
                </div>
                <div class="input-box">
                    <input type="email" id="email" placeholder="Email" name="email" required pattern="^[a-zA-Z0-9._%+-]+@gmail\.com$">
                    <div class="error-message" id="error-email"></div>
                </div>
                <div class="input-box">
                    <input type="tel" placeholder="Mobile number" id="phone" name="phone" required pattern="08\d{8}">
                    <div class="error-message" id="error-tel"></div>
                </div>
                <div class="input-box">
                    <input type="password" id="password" placeholder="Password" name="password" required minlength="6" maxlength="12">
